        ...
        if (
          ...
          if ("string" === typeof b)
            ...
            b instanceof ERNO.Direction
              ? (a[c] = b.initial)
              : b instanceof Array
              ? ((d = a.slice(0, c)), (h = a.slice(c + 1)), (a = d.concat(b, h)))
              : a.splice(c, 1),
              c--;
      return a;
    };
      ...
      this.rotateGroupMappingOnAxis = (function() {
        ...
        return function(m) {
          ...
          for (var q = a.length, p; 0 < q--; )
            (p = b.cubelets[a[q]]),
              e.set(p.addressX, p.addressY, p.addressZ),
              f.copy(e),
              e.multiply(c).applyMatrix4(h),
              (e.x = Math.round(e.x)),
              (e.y = Math.round(e.y)),
              (e.z = Math.round(e.z)),
              ...
              (e.y = 2 - e.y),
              (e.z = 2 - e.z),
              (b.cubelets[p.address] = s[9 * e.z + 3 * e.y + e.x]);
      ...
      return function(a, b) {
        ...
        function d(d, f, l) {
          ...
          t !== document &&
            ...
            (k.left += window.pageXOffset - t.clientLeft),
            (k.top += window.pageYOffset - t.clientTop));
          e = k;
        ...
        return {
          getIntersection: function(b, c, e, f, g) {
            ...
            d(b, c, e);
            return q.isIntersectionSphere(k) && null !== q.intersectBox(p, f)
              ? (g &&
                  ...
                  g.setFromNormalAndCoplanarPoint(s, f)),
                f)
              : null;
          },
    ...
    ERNO.Interaction = (function() {
      return function(a, b, c, d, e) {
        function f(e) {
          v.enabled &&
            2 !== e.button &&
            ((l = ((e.touches && e.touches[0]) || e).clientX),
            (u = ((e.touches && e.touches[0]) || e).clientY),
            m.getIntersection(b, l, u, s, w) &&
              (null !== e.touches && e.preventDefault(),
              0 === a.isTweening() &&
                ((E =
                  ...
                  void 0 !== window.performance.now
                    ...
                    : Date.now()),
                (v.active = !0),
                (q = m.getCubeletAtIntersection(s)),
                (p = [
                  a.slices[q.addressX + 1],
                  a.slices[q.addressY + 4],
                  a.slices[q.addressZ + 7]
                ]),
                c.addEventListener("mousemove", h),
                c.addEventListener("touchmove", h),
                c.addEventListener("mouseup", g),
                c.addEventListener("touchcancel", g),
                c.addEventListener("touchend", g),
                c.removeEventListener("mousedown", f),
                c.removeEventListener("touchstart", f))));
        }
        function h(a) {
          v.active &&
            ((x.x = ((a.touches && a.touches[0]) || a).clientX),
            (x.y = ((a.touches && a.touches[0]) || a).clientY));
          v.enabled && (a.preventDefault(), a.stopImmediatePropagation());
        }
        function g(b) {
          var e = ((b.touches && b.touches[0]) || b).clientX,
            d = ((b.touches && b.touches[0]) || b).clientY;
          v.active = !1;
          v.enabled &&
            (e !== u || d !== u) &&
            n &&
            (null !== b.touches && b.preventDefault(),
            (b = k.name[0].toUpperCase()),
            (e = Math.round((C / Math.PI) * 2) * Math.PI * 0.5),
            0.3 <
              t.length() /
                (("undefined" !== typeof window &&
                void 0 !== window.performance &&
                void 0 !== window.performance.now
                  ...
                  : Date.now()) -
                  E) &&
              ((e = Math.floor((C / Math.PI) * 2) * Math.PI * 0.5),
              (e += 0 < D.dot(t.normalize()) ? 0.5 * Math.PI : 0)),
            a.twist(new ERNO.Twist(b, e.radiansToDegrees())));
          E = 0;
          x.x = void 0;
          x.y = void 0;
          n = !1;
        ...
        v.getIntersectionAt = (function() {
          var a = new THREE.Vector3(),
            c = new THREE.Plane();
          return function(e, d) {
            return null === m.getIntersection(b, e, d, a, c)
              ? null
              : {
        ...
        v.update = function() {
          ...
          v.enabled &&
            ...
            void 0 != e &&
            (l !== c || u !== e) &&
            (m.getIntersectionOnPlane(b, c, e, w, A),
            t.subVectors(A, s),
            !n &&
              5 < t.length() &&
              (k && (k.rotation = 0),
              (n = !0),
              r.crossVectors(w.normal, t),
              (c = Math.max(Math.abs(r.x), Math.abs(r.y), Math.abs(r.z))),
              (r.x = (r.x / c) | 0),
              (r.y = 1 === r.x ? 0 : (r.y / c) | 0),
              (r.z = 1 === r.x || 1 === r.y ? 0 : (r.z / c) | 0),
              (k = p[Math.abs(3 * r.z + 2 * r.y + r.x) - 1]),
              D.crossVectors(k.axis, w.normal).normalize()),
            n && (t.subVectors(A, s), (C = (D.dot(t) / a.size) * v.dragSpeed)),
            k && (k.rotation = C));
        };
        c.addEventListener("mousedown", f);
        c.addEventListener("touchstart", f);
        ...
        c.addEventListener("mouseup", function(a) {
          ...
          a = a.clientY;
          !n &&
            Math.abs(Math.sqrt((b - y) * (b - y) + (a - z) * (a - z))) <
        ...
        c.addEventListener("touchend", function(a) {
          ...
          !n &&
            Math.abs(Math.sqrt((b - y) * (b - y) + (c - z) * (c - z))) <
              10 * (window.devicePixelratio || 1) &&
            F(y, z) &&
            a.preventDefault();
        });
    ...
    ERNO.Controls = (function() {
      ...
      return function(c, d, e) {
        function f(b) {
          n.enabled &&
            1 === b.which &&
            null === A.getIntersection(d, b.pageX, b.pageY) &&
            ((p = a),
            k.multiplyScalar(0),
            w(b.pageX, b.pageY, l),
            u.copy(l),
            n.domElement.removeEventListener("mousedown", f),
        ...
        function m(b) {
          n.enabled &&
            null ===
              A.getIntersection(d, b.touches[0].pageX, b.touches[0].pageY) &&
            ((p = a),
            k.multiplyScalar(0),
            w(b.touches[0].pageX, b.touches[0].pageY, l),
            u.copy(l),
            n.domElement.removeEventListener("touchstart", m),
        ...
        function s(b) {
          n.enabled &&
            ((p = a),
            w(b.changedTouches[0].pageX, b.changedTouches[0].pageY, l),
            k.subVectors(l, u),
            u.copy(l));
        }
        function q(a) {
        ...
        n.update = (function() {
          ...
          return function() {
            !1 !== n.enabled &&
              -1 !== p &&
              (e.set(k.y, -1 * k.x, 0).normalize(),
              g.getInverse(c.matrixWorld),
              g.multiply(d.matrixWorld),
              e.transformDirection(g),
              k.multiplyScalar(1 - Math.max(0, Math.min(1, n.damping))),
              (f = k.length()),
              c.object3D.rotateOnAxis(e, -f * n.rotationSpeed),
              p === a ? (p = -1) : p === b && 1e-4 <= f ? l.add(k) : (p = -1));
          };
        })();
        n.domElement.addEventListener("mousedown", f);
        n.domElement.addEventListener("touchstart", m);
    ...
    ERNO.renderers.CSS3D = function(a, b) {
      ...
      function e() {
        return Array.prototype.slice.call(
          h.domElement.querySelectorAll(".faceLabel")
        );
      }
      function f() {
      ...
      b.faces.forEach(function(a, c) {
        m = b[a.face].label = new THREE.CSS3DObject(
    ...
    ERNO.renderers.CSS3DCubelet = (function() {
      return function(a) {
        ...
        a.faces.forEach(function(b) {
          ...
          f.appendChild(h);
          f = b.element.style;
          f.OTransform = f.MozTransform = f.WebkitTransform = f.transform =
            c[b.id];
          b.isIntrovert
